...
int main(){
    ...
    FILE *fp = NULL; 
    fp = fopen("runge_kutta_3_data.txt", "w");
    if(fp == NULL){
    ...
    fprintf(gnuplotPipe, "set output 'rc_rk3_plot.png'\n");
    ...
    fprintf(gnuplotPipe, "plot 'runge_kutta_3_data.txt' using 1:2 with lines linewidth 2 linecolor rgb 'red'\n");
